        	...
        	<div class="row">
                ...
                <div id="errorMessage" class="alert alert-error" style="display:none;"></div>
        				  <form id="publier" align="left">
			                ...
			                Destinataire:
			                <input id="destinataire" name="destinataire" type="text" placeholder="Nom d'utilisateur du destinataire"/>
				...
				<ul class="nav nav-list">
	              ...
	              <li id="toutLeMonde" class="birneo_unselectable" style="cursor: pointer;"><a href="../inbox">Boîte de réception</a></li>
	              <li id="amis" class="active birneo_unselectable" style="cursor: pointer;"><a href="../archives">Archives</a></li>
	              <!--<li><a href="#">Link</a></li>
	              <li><a href="#">Link</a></li>-->
            	</ul>
        		</div>
                        ...
                        >
                          ...
                          <div class="media-body">
                            ...
                            <div class="pull-left;" style="max-width:500px;">
                              ...
                              <?php echo tronque($row['message'],60); ?></div>
