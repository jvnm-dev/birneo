<?php
	...
	$t = array();
	$query = $bdd->query("DELETE FROM friends WHERE id_exp = :id_exp AND id_dest = :id_dest",array("id_exp"=>$id_exp,"id_dest"=>$id_dest));
	
	$contenu = $profile[0]['surname']." ".$profile[0]['name']." a refusé votre invitation";
